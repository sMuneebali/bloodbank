...
$query = "INSERT INTO `tbl_donate`(`d_id`, `d_name`, `d_bloodgroup`, `d_lastdonate`, `d_contact`, `d_CNIC`, `d_location`, `d_age`, `d_gender`) VALUES('','$name','$bloodgroup','$lastdonate','$phone','$cnic','$location','$AGE','$gender')";
$queryup="UPDATE `tbl_bloodgroup` SET `quantity`= '$count' WHERE `bloodgroup`='$bloodgroup'";
$rs = mysqli_query($con, $query);
$rss = mysqli_query($con, $queryup);
echo '<script>alert("your registration successfully complete ")</script>';
    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h1 class="title" style="font-family:Arial;">Donation Form</h1>
                    <form method="POST">
...
?>
						...
						<div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input type="date"class="input--style-2" name="lastdonate" id="lastdonate" required>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
       ...
       <!--*************** Footer  Starts Here *************** -->
     <footer id="contact" class="container-fluid" style="background-color:#00BFA5;">
